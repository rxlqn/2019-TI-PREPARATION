...
#include "main.h"
#define numStages  3               							    /* 2阶IIR滤波的个数 */ //每个需要5个系数，4个状态变量
...
{
    1.0f,  2.0f,  1.0f,  1.9282146342505341f,   -0.938468571848044f,
    1.0f,  2.0f,  1.0f,  1.83677978948090f,     -0.846547491170929f,

    1.0f,  1.0f,  0.0f,  0.90205138821162f,     -0.0f,
};
 ...
 void arm_iir_f32_Lp(float fInputData[], float fOutputData[], uint32_t u32Len)
{
	...
	// 乘缩放系数
    float32_t ScaleValue = 0.00256348439937f * 0.00244192542250f * 0.04897430589418f;
