 ...
 *                                             CONSTANTS
 ***************************************************************************************************/
#define TriWire_Port  GPIOA
#define TriWire_IO    GPIO_PIN_6
#define TriWire_SCLK  GPIO_PIN_7
#define TriWire_LE    GPIO_PIN_8
#define TriWire_CE    GPIO_PIN_9
#define TriWireDELAY  200

#define IO_H   		  HAL_GPIO_WritePin(TriWire_Port, TriWire_IO, GPIO_PIN_SET)
#define IO_L   		  HAL_GPIO_WritePin(TriWire_Port, TriWire_IO, GPIO_PIN_RESET)
#define SCLK_H   	  HAL_GPIO_WritePin(TriWire_Port, TriWire_SCLK, GPIO_PIN_SET)
#define SCLK_L   	  HAL_GPIO_WritePin(TriWire_Port, TriWire_SCLK, GPIO_PIN_RESET)
#define LE_H   	  	  HAL_GPIO_WritePin(TriWire_Port, TriWire_LE, GPIO_PIN_SET)
#define LE_L   	      HAL_GPIO_WritePin(TriWire_Port, TriWire_LE, GPIO_PIN_RESET)
#define CE_H   	  	  HAL_GPIO_WritePin(TriWire_Port, TriWire_CE, GPIO_PIN_SET)
#define CE_L   	      HAL_GPIO_WritePin(TriWire_Port, TriWire_CE, GPIO_PIN_RESET)


// Frequency Settings
// Initally, the synthesizer will operate at 2450 MHz
#define ADF4113_REF_FREQ_MHZ          20
#define ADF4113_RF_CENTER_FREQ_MHZ    401
...
extern void ADF4110_GPIO_init(void);
