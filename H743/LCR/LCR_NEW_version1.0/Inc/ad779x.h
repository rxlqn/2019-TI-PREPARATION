...
unsigned short AD779X_HWDetect(void);
unsigned char AD779X_GetStatus(void);
unsigned char AD779X_CheckReadySW(void);
unsigned char AD779X_CheckReadyHW(void);
...
void AD779X_StartZSCalibration(void);
void AD779X_StartFSCalibration(void);
unsigned short AD779X_ReadOffsetRegister16(void);
unsigned long  AD779X_ReadOffsetRegister24(void);
unsigned short AD779X_ReadFScaleRegister16(void);
unsigned long  AD779X_ReadFScaleRegister24(void);
unsigned short AD779X_ReadDataRegister16(void);
unsigned long  AD779X_ReadDataRegister24(void);
unsigned short AD779X_ReadDataSample16(void);
unsigned long  AD779X_ReadDataSample24(void);
