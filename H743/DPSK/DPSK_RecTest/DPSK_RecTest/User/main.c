...
//				if( u32DataIn & index)
//				{
//						aSRC_Buffer[160 + i] = aSRC_Pi[i%160];
//						u32ForePhse = 180;
//				}
//				else
//				{
//						aSRC_Buffer[160 + i] = aSRC_0[i%160];
//						u32ForePhse = 0;
//				}
//		}
...
//				for( i = 0; i < 160; i++ )
//				{
//						 u16DecodeOutBuf[i] = (u16WorkingBuf[i] * u16DecodeOutBuf[8000 + i]) >> 12;
//				}
//				for( i = 0; i < 4000 - 160; i++ )
//				{
//						 u16DecodeOutBuf[160 + i] = ((uint32_t)u16WorkingBuf[i + 160] * (uint32_t)u16WorkingBuf[i]) >> 12;
//				}
