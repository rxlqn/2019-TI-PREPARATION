...
const float32_t IIRCoeffs32BP[5 * numStages] =
{
    1.0f,  2.0f,  1.0f,  1.31143002312016f,   -0.744134250363772f,
    1.0f,  2.0f,  1.0f,  1.0657465812766107f,   -0.4173879519626f,
    1.0f,  2.0f,  1.0f,  0.94343631177393f,   -0.25472160572232f,
 
    1.0f,  1.0f,  0.0f,  0.4531572393812f,  -0.f  
};
/* 巴特沃斯低通滤波器系数3000Hz，阻带8000Hz fs = 200000Hz*/
volatile float32_t ScaleValue = 	0.1081760568109 *
                                    0.0879103426715 *
                                    0.0778213234870 *
                                    0.2734213803093;
