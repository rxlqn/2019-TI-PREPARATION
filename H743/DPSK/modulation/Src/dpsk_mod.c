...
void Phase_init()	// 一个bit的周期数 N_phase/N 
{
	...
	{
		aSRC_0[i] = 32767*0.8*(arm_sin_f32(i*2*(float)3.1415926535/(float)Num_T)) + (float)1*32767.; 
	}
	// Phase Pi
	for(int i = 0; i < N_phase; i++)
	{
		aSRC_Pi[i] = 32767*0.8*(-arm_sin_f32(i*2*(float)3.1415926535/(float)Num_T)) + (float)1*32767.; 
	}
}
