...
{
    1.0f,  2.0f,  1.0f,  1.31143002312016f,   -0.7441342503637f,
	1.0f,  2.0f,  1.0f,  1.065746581276f,   -0.417387951962663f,
	1.0f,  2.0f,  1.0f,  0.94343631177393f,   -0.254721605722322f,
	1.0f,  1.0f,  0.0f,  0.4531572393812f,   -0.f,
 ...
 void arm_iir_f32_Lp(float fInputData[], float fOutputData[], uint32_t u32Len)
{
	...
	// 乘缩放系数
    float32_t ScaleValue = 0.108176056810f * 0.087910342671f*0.07782132348f*0.27342138030;
